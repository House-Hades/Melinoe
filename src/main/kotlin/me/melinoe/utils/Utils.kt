...
fun logError(throwable: Throwable, context: Any) {
    ...
    Message.chat("$message <click:copy_to_clipboard:'$errorText'><hover:show_text:'<#FFD700>Click to copy the error to your clipboard.'><#FF3333>Please click this message to copy and send it in the Melinoe discord!</click>")
}
