        ...
        on<RenderEvent.Extract> {
            ...
            if (AbilityRangeModule.enabled) {
                ...
                if (abilityStack != null) {
                    val (abilityRangeInfo, _) = ItemUtils.getItemRangeWithOffset(abilityStack)
                    if (abilityRangeInfo.baseRange == rangeInfo.baseRange && 
                        abilityRangeInfo.minRange == rangeInfo.minRange &&
                        abilityRangeInfo.maxRange == rangeInfo.maxRange) {
            ...
            // Draw center dot for other items with offset
            if (offset != 0f) {
