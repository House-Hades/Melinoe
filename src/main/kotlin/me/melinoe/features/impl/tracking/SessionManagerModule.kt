...
object SessionManagerModule : Module(
    ...
    private val widgetColor by ColorSetting(
        "Widget Color",
        Color(0xFF7CFFB2.toInt()),
        desc = "Color for the widget border and title"
    )
    private val textColorSetting by ColorSetting(
        "Label Color",
        Color(0xFFB8FFE1.toInt()),
        desc = "Color for the tracking labels"
    )
